...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 2 \"modint/modint-arbitrary.hpp\"\n\n#line 2 \"modint/barrett-reduction.hpp\"\
    \n\n#include <utility>\nusing namespace std;\n\nstruct Barrett {\n  using u32\
    ...
    \ = rem(n), r = m == 1 ? 0 : 1;\n    while (p) {\n      if (p & 1) r = rem(u64(r)\
    \ * a);\n      a = rem(u64(a) * a);\n      p >>= 1;\n    }\n    return r;\n  }\n\
    };\n#line 4 \"modint/modint-arbitrary.hpp\"\n\nstruct ArbitraryModInt {\n  int\
  ...
  verifiedWith: []
documentation_of: modint/modint-arbitrary.hpp
layout: document
redirect_from:
- /library/modint/modint-arbitrary.hpp
- /library/modint/modint-arbitrary.hpp.html
